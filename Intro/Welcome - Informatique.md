...
Cycle propédeutique 1e année : en commun avec syscom
	-> on peut changer de section 

[S'inscrire au cours](https://is-academia.epfl.ch), dernier délai 19 Septembre 2025

## Examens 

il faut avoir 4.0 de moyenne dans chaque bloc (bloc 1 et bloc 2)
Ne pas s'inscrire à un cour => échec
## Branches

### Automne

- Intro à la programation
- Analyse I
- Algèbre linéaire
- Advanced information computation communication I
- Physique mécanique générale : mécanique
### Printemps
